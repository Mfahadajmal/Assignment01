...
public final class AppCompatDrawableManager {
    ...
    /* compiled from: PG */
    /* renamed from: android.support.v7.widget.AppCompatDrawableManager$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public static synchronized void preload() {
        synchronized (AppCompatDrawableManager.class) {
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks$ar$class_merging(new AnonymousClass1());
            }
        }
    }
    ...
    public final synchronized Drawable getDrawable$ar$ds(Context context, int i) {
        return this.mResourceManager.getDrawable(context, i, true);
    }
