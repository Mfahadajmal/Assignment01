...
public final class IconDetectionModuleDownloadPrompter extends ModuleDownloadPrompter {
    ...
    public IconDetectionModuleDownloadPrompter(Context context, Downloader downloader) {
        super(context, downloader, ImageCaptionUtils$CaptionType.ICON_LABEL, ImageCaptionConstants$ImageCaptionPreferenceKeys.ICON_DETECTION, ImageCaptionConstants$DownloadDialogResources.ICON_DETECTION, ImageCaptionConstants$UninstallDialogResources.ICON_DETECTION);
    }
