...
public final class EditBufferEbae2 extends EditBufferContracted {
    private final Set forceInitialTranslationSet;
    private final Set forceNonInitialTranslationSet;

    public EditBufferEbae2(Context context, BrailleTranslator brailleTranslator, OnDeviceTextDetectionLoadLogEvent onDeviceTextDetectionLoadLogEvent) {
        super(context, brailleTranslator, onDeviceTextDetectionLoadLogEvent);
        HashSet hashSet = new HashSet();
        this.forceNonInitialTranslationSet = hashSet;
        HashSet hashSet2 = new HashSet();
        this.forceInitialTranslationSet = hashSet2;
        hashSet2.add("6");
        hashSet2.add("23");
        hashSet.add("2");
        hashSet.add("23");
