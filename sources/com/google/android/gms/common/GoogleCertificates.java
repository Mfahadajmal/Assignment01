...
import com.google.android.gms.common.internal.IGoogleCertificatesApi$Stub$Proxy;
...
public final class GoogleCertificates {
    ...
    /* compiled from: PG */
    /* renamed from: com.google.android.gms.common.GoogleCertificates$2 */
    /* loaded from: classes.dex */
    final class AnonymousClass2 extends LazyCertData {
        public AnonymousClass2(byte[] bArr) {
            super(bArr);
        }
    ...
    /* compiled from: PG */
    /* renamed from: com.google.android.gms.common.GoogleCertificates$3 */
    /* loaded from: classes.dex */
    final class AnonymousClass3 extends LazyCertData {
        public AnonymousClass3(byte[] bArr) {
            super(bArr);
        }
    ...
    /* compiled from: PG */
    /* renamed from: com.google.android.gms.common.GoogleCertificates$4 */
    /* loaded from: classes.dex */
    final class AnonymousClass4 extends LazyCertData {
        public AnonymousClass4(byte[] bArr) {
            super(bArr);
        }
    ...
    /* compiled from: PG */
    /* loaded from: classes.dex */
    public final class FullCertData extends ICertData.Stub {
        ...
        @Override // com.google.android.gms.common.internal.ICertData.Stub
    ...
    /* compiled from: PG */
    /* loaded from: classes.dex */
    public abstract class LazyCertData extends ICertData.Stub {
        private static final WeakReference EMPTY_REF = new WeakReference(null);
        private WeakReference cachedFullCert;

        public LazyCertData(byte[] bArr) {
            super(bArr);
            this.cachedFullCert = EMPTY_REF;
        }
        ...
        public final byte[] getBytes() {
            byte[] bArr;
            synchronized (this) {
                bArr = (byte[]) this.cachedFullCert.get();
                if (bArr == null) {
                    bArr = loadBytes();
                    this.cachedFullCert = new WeakReference(bArr);
                }
            }
            return bArr;
        }
    ...
    public final class VALID_PUBLIC_SIGNATURES {
        static final ICertData.Stub[] KEYS$ar$class_merging = {GoogleCertificates.APP_RELEASE_CERT, GoogleCertificates.APP_DEBUG_CERT};
    }
    ...
    public static void initDynamiteModuleLocked() {
        IGoogleCertificatesApi iGoogleCertificatesApi$Stub$Proxy;
        if (googleCertificatesApi != null) {
            return;
        }
        StrictModeUtils$VmPolicyBuilderCompatS.checkNotNull$ar$ds$ca384cd1_1(context);
        synchronized (initLock) {
            if (googleCertificatesApi == null) {
                IBinder instantiate = DynamiteModule.load(context, DynamiteModule.PREFER_HIGHEST_OR_LOCAL_VERSION_NO_FORCE_STAGING, "com.google.android.gms.googlecertificates").instantiate("com.google.android.gms.common.GoogleCertificatesImpl");
                if (instantiate == null) {
                    iGoogleCertificatesApi$Stub$Proxy = null;
                } else {
                    ...
                    if (queryLocalInterface instanceof IGoogleCertificatesApi) {
                        iGoogleCertificatesApi$Stub$Proxy = (IGoogleCertificatesApi) queryLocalInterface;
                    } else {
                        iGoogleCertificatesApi$Stub$Proxy = new IGoogleCertificatesApi$Stub$Proxy(instantiate);
                    }
                }
                googleCertificatesApi = iGoogleCertificatesApi$Stub$Proxy;
            }
        }
    }

    public static GoogleCertificatesResult query$ar$class_merging(String str, ICertData.Stub stub, boolean z, boolean z2) {
        StrictMode.ThreadPolicy allowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            return queryInternal$ar$class_merging(str, stub, z, z2);
        } finally {
            StrictMode.setThreadPolicy(allowThreadDiskReads);
        }
    }

    public static GoogleCertificatesResult queryInternal$ar$class_merging(final String str, final ICertData.Stub stub, final boolean z, boolean z2) {
        try {
            initDynamiteModuleLocked();
            StrictModeUtils$VmPolicyBuilderCompatS.checkNotNull$ar$ds$ca384cd1_1(context);
            try {
                if (googleCertificatesApi.isGoogleOrPlatformSigned(new GoogleCertificatesQuery(str, stub, z, z2), new IObjectWrapper.Stub(context.getPackageManager()))) {
                    return GoogleCertificatesResult.ALLOWED_INSTANCE;
                }
                return new GoogleCertificatesResult.NotAllowedResult(new Callable() { // from class: com.google.android.gms.common.GoogleCertificates$$ExternalSyntheticLambda0
                    @Override // java.util.concurrent.Callable
                    public final Object call() {
                        String str2;
                        IGoogleCertificatesApi iGoogleCertificatesApi = GoogleCertificates.googleCertificatesApi;
                        String str3 = str;
                        boolean z3 = z;
                        ICertData.Stub stub2 = stub;
                        if (!z3 && GoogleCertificates.queryInternal$ar$class_merging(str3, stub2, true, false).allowed) {
                            str2 = "debug cert rejected";
                        } else {
                            str2 = "not allowed";
                        }
                        MessageDigest messageDigest$ar$ds = AndroidUtilsLight.getMessageDigest$ar$ds();
                        StrictModeUtils$VmPolicyBuilderCompatS.checkNotNull$ar$ds$ca384cd1_1(messageDigest$ar$ds);
                        byte[] digest = messageDigest$ar$ds.digest(stub2.getBytes());
                        ...
                        return String.format("%s: pkg=%s, sha256=%s, atk=%s, ver=%s", str2, str3, new String(cArr2), Boolean.valueOf(z3), "242525000.false");
                    }
                });
            } catch (RemoteException e) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e);
                return GoogleCertificatesResult.error("module call", e);
            }
        } catch (DynamiteModule.LoadingException e2) {
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e2);
            return GoogleCertificatesResult.error("module init: ".concat(String.valueOf(e2.getMessage())), e2);
        }
    }
}
