...
public final class SystemInfoDialogFragment extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        inflate.findViewById(R.id.survey_system_info_dialog_ok_button).setOnClickListener(new TrainingActivity$$ExternalSyntheticLambda0(create, 9));
        ...
        recyclerView.addOnScrollListener$ar$class_merging(new AppCompatSpinner.Api23Impl(this) { // from class: com.google.android.libraries.surveys.internal.view.SystemInfoDialogFragment.1
            final /* synthetic */ SystemInfoDialogFragment this$0;
