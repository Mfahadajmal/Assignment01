...
public enum MLKitEnum$EventName implements ProtoEnum {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_DI_DOWNLOAD(FeatureName.CHROMEOS_READER_TOC$ar$edu),
    ON_DEVICE_DI_RECOGNIZE(FeatureName.CHROMEOS_READER_Q_AND_A$ar$edu),
    ...
    CLOUD_LOGO_CLOSE(93),
    CLOUD_SAFE_SEARCH_CREATE(BrailleInputEvent.CMD_HEADING_PREVIOUS),
    CLOUD_SAFE_SEARCH_DETECT(BrailleInputEvent.CMD_CONTROL_NEXT),
    CLOUD_SAFE_SEARCH_CLOSE(BrailleInputEvent.CMD_CONTROL_PREVIOUS),
    CLOUD_TEXT_CREATE(BrailleInputEvent.CMD_BRAILLE_DISPLAY_SETTINGS),
    CLOUD_TEXT_DETECT(BrailleInputEvent.CMD_TALKBACK_SETTINGS),
    CLOUD_TEXT_CLOSE(BrailleInputEvent.CMD_TURN_OFF_BRAILLE_DISPLAY),
    CLOUD_WEB_SEARCH_CREATE(BrailleInputEvent.CMD_TOGGLE_AUTO_SCROLL),
    CLOUD_WEB_SEARCH_DETECT(BrailleInputEvent.CMD_INCREASE_AUTO_SCROLL_DURATION),
    CLOUD_WEB_SEARCH_CLOSE(BrailleInputEvent.CMD_DECREASE_AUTO_SCROLL_DURATION),
    CUSTOM_MODEL_RUN(102),
    CUSTOM_MODEL_CREATE(ExtensionTalkback$TalkbackExtension.EventLatencyInfo.EventType.TYPE_FINGERPRINT_GESTURE$ar$edu),
    CUSTOM_MODEL_CLOSE(ExtensionTalkback$TalkbackExtension.EventLatencyInfo.EventType.TYPE_KEY_EVENT$ar$edu),
    CUSTOM_MODEL_LOAD(ExtensionTalkback$TalkbackExtension.EventLatencyInfo.EventType.TYPE_DEVICE_ROTATE$ar$edu),
    ...
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(FeatureName.AI_WALLPAPER_SAMSUNG$ar$edu),
    ...
    AGGREGATED_ON_DEVICE_FACE_DETECTION(TrainingProto$TrainingPageId.PAGE_ID_WATCH_GO_BACK$ar$edu),
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(TrainingProto$TrainingPageId.PAGE_ID_WATCH_VOLUME_UP$ar$edu),
    AGGREGATED_ON_DEVICE_OBJECT_INFERENCE(TrainingProto$TrainingPageId.PAGE_ID_WATCH_VOLUME_DOWN$ar$edu),
    AGGREGATED_ON_DEVICE_TEXT_DETECTION(TrainingProto$TrainingPageId.PAGE_ID_WATCH_OPEN_TALKBACK_MENU$ar$edu),
    AGGREGATED_ON_DEVICE_POSE_DETECTION(TrainingProto$TrainingPageId.PAGE_ID_WATCH_END_TUTORIAL$ar$edu),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID(FeatureName.STYLUS_IMAGE_CAPTION$ar$edu),
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(FeatureName.STYLUS_SKETCH_TO_IMAGE$ar$edu),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_CREATE(FeatureName.GENC_COMPUTE$ar$edu),
    ...
    ON_DEVICE_IMAGE_CAPTIONING_CREATE(FeatureName.AM_GENERATIVE_STICKERS$ar$edu),
    ...
    ON_DEVICE_SHADOW_REMOVAL_CREATE(FeatureName.CHROME_ACCESSIBILITY_IMAGE_DESCRIPTION$ar$edu),
