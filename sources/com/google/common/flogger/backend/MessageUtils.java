...
public final class MessageUtils {
    ...
    public static void appendHex(StringBuilder sb, long j, boolean z) {
        String str;
        if (j == 0) {
            sb.append("0");
            return;
    ...
    public static String getErrorString(Object obj, RuntimeException runtimeException) {
        String simpleName;
        try {
        ...
        try {
            if (!obj.getClass().isArray()) {
                ...
                if (obj2 != null) {
                    ...
                    obj = formatErrorMessageFor(obj, "toString() returned null");
                }
