...
public final class EmojiKeyListener implements KeyListener {
    private final TraceCompat.Api29Impl mEmojiCompatHandleKeyDownHelper$ar$class_merging;
    private final KeyListener mKeyListener;

    public EmojiKeyListener(KeyListener keyListener) {
        TraceCompat.Api29Impl api29Impl = new TraceCompat.Api29Impl();
        this.mKeyListener = keyListener;
        this.mEmojiCompatHandleKeyDownHelper$ar$class_merging = api29Impl;
    }
    ...
    */
    public final boolean onKeyDown(android.view.View r4, android.text.Editable r5, int r6, android.view.KeyEvent r7) {
        /*
            ...
            goto L1a
        Lb:
            boolean r0 = androidx.core.os.BundleApi21ImplKt.delete(r5, r7, r1)
            goto L14
        L10:
            boolean r0 = androidx.core.os.BundleApi21ImplKt.delete(r5, r7, r2)
        L14:
            if (r0 == 0) goto L1a
            android.text.method.MetaKeyKeyListener.adjustMetaAfterKeypress(r5)
            goto L22
        L1a:
            android.text.method.KeyListener r0 = r3.mKeyListener
        ...
        L23:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.viewsintegration.EmojiKeyListener.onKeyDown(android.view.View, android.text.Editable, int, android.view.KeyEvent):boolean");
    }
