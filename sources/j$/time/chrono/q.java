...
public final class q extends AbstractC0011a implements Serializable {
    ...
    static {
        q qVar = new q();
        o = qVar;
        AbstractC0011a.n(qVar, "Hijrah");
        AbstractC0011a.n(qVar, "islamic");
    }
    ...
    private void p() {
        if (!this.f) {
            ...
            try {
                ...
                int[][] L = L();
                int A = (int) j$.time.g.V(1882, 11, 12).A();
    ...
    public final InterfaceC0012b H(Temporal temporal) {
        ...
        return s.R(this, temporal.z(j$.time.temporal.a.EPOCH_DAY));
    }
