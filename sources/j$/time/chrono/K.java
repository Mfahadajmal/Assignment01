...
public final class K extends AbstractC0014d {
    ...
    private K R(j$.time.g gVar) {
        return gVar.equals(this.a) ? this : new K(gVar);
    }
    ...
    */
    public final j$.time.chrono.K e(long r9, j$.time.temporal.o r11) {
        /*
            r8 = this;
        ...
        L9a:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.K.e(long, j$.time.temporal.o):j$.time.chrono.K");
    }
    ...
    public final InterfaceC0012b n(long j, TemporalUnit temporalUnit) {
        return (K) super.n(j, temporalUnit);
    }
