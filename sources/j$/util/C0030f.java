...
public final class C0030f implements java.util.Map, Serializable, Map {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C0030f(java.util.Map map) {
        map.getClass();
        this.a = map;
        this.b = this;
    }
    ...
    */
    public final java.lang.Object compute(java.lang.Object r5, java.util.function.BiFunction r6) {
        ...
        L41:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.util.C0030f.compute(java.lang.Object, java.util.function.BiFunction):java.lang.Object");
    }
    ...
    */
    public final java.lang.Object computeIfPresent(java.lang.Object r5, java.util.function.BiFunction r6) {
        ...
        L3c:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.util.C0030f.computeIfPresent(java.lang.Object, java.util.function.BiFunction):java.lang.Object");
    }
    ...
    /* JADX WARN: Type inference failed for: r1v3, types: [j$.util.d, java.util.Set] */
    @Override // java.util.Map
    public final java.util.Set entrySet() {
        ...
        synchronized (this.b) {
            try {
                if (this.d == null) {
                    this.d = new C0028d(this.a.entrySet(), (Serializable) this.b);
                }
                set = this.d;
            } catch (Throwable th) {
                throw th;
    ...
    public final java.util.Set keySet() {
        ...
        synchronized (this.b) {
            try {
                if (this.c == null) {
                    this.c = new C0028d(this.a.keySet(), (Serializable) this.b);
                }
                set = this.c;
            } catch (Throwable th) {
                throw th;
    ...
    */
    public final java.lang.Object merge(java.lang.Object r5, java.lang.Object r6, java.util.function.BiFunction r7) {
        ...
        L46:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.util.C0030f.merge(java.lang.Object, java.lang.Object, java.util.function.BiFunction):java.lang.Object");
    }
    ...
    public final void replaceAll(BiFunction biFunction) {
        synchronized (this.b) {
            ...
            if (map instanceof Map) {
                ...
                if (concurrentMap instanceof j$.util.concurrent.y) {
                    ((j$.util.concurrent.y) concurrentMap).forEach(wVar);
                } else {
                    j$.util.concurrent.x.a(concurrentMap, wVar);
                }
            } else {
    ...
    public final java.util.Collection values() {
        ...
        synchronized (this.b) {
            try {
                if (this.e == null) {
                    this.e = new C0028d(this.a.values(), (Serializable) this.b);
                }
                collection = this.e;
            } catch (Throwable th) {
                throw th;
