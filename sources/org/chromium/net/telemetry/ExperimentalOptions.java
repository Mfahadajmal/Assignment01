...
public final class ExperimentalOptions {
    public static final Set VALID_CONNECTION_OPTIONS;
    ...
    static {
        ...
        VALID_CONNECTION_OPTIONS = DesugarCollections.unmodifiableSet(hashSet);
    }

    public ExperimentalOptions(String str) {
        this.mJson = new JSONObject();
        if (!isNullOrEmpty$ar$ds(str)) {
            try {
    ...
    public static final boolean isNullOrEmpty$ar$ds(String str) {
    ...
    public final Object getOrDefault(String str, String str2, Object obj, Class cls) {
